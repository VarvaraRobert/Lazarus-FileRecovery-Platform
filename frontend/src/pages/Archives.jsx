...
const translations = {
  en: {
    ...
    subtitle: 'Recent forensic scan operations.',
    ...
    allRecords: 'Recent Scan Records', records: 'records',
  ...
  de: {
    ...
    subtitle: 'Aktuelle forensische Scan-Operationen.',
    ...
    allRecords: 'Aktuelle Scan-Einträge', records: 'Einträge',
  ...
  fr: {
    ...
    subtitle: 'Opérations de scan forensique récentes.',
    ...
    allRecords: 'Enregistrements récents', records: 'enregistrements',
